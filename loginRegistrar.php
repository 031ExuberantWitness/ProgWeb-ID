						...
						<div class="form">
							...
							<div class="form-panel one">
								<div class="form-header">
									<h1>Registrar CURP</h1>
								</div>
								<div class="form-content">
									<form action="php/registrarLogin.php" method="POST">
										<div class="form-group"><label for="curp">CURP</label>
											<input type="text" id="rCurp" name="rCurp" required="required" /></div>
										<div class="form-group"><label for="clave">Contraseña</label>
											<input type="password" id="rClave" name="rClave" required="required" /></div>
										<div class="form-group"><label for="cclave">Confirmar la contraseña</label>
											<input type="password" id="rCClave" name="rCClave" required="required" /></div>
										<div class="form-group"><label for="email">Correo electrónico</label>
											<input type="email" id="rCorreo" name="rCorreo" required="required" /></div>
										<div class="form-group">
											<button type="submit" value="Registrar" name="btnRegistrar">Registrar</button></div>
									</form>
								</div>
							</div>
						</div>
